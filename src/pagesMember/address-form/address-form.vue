  ...
  <view class="content">
    <uni-forms :rules="rules" :model="form" ref="formRef">
      ...
      <view class="form-item">
        ...
        <switch class="switch" @change="onSwitchChange" color="#27ba9b" :checked="form.isDefault === 1" />
      </view>
    </uni-forms>
  </view>
  <!-- 提交按钮 -->
...
import { onLoad } from '@dcloudio/uni-app';
  ...
  const onRegionPicker: UniHelper.RegionPickerOnChange = (ev) => {
