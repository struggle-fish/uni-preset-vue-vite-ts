<template>
  <scroll-view scroll-y class="scroll-view">
    ...
    <template v-if="memberStore.profile">
      <!-- 购物车列表 -->
      <view class="cart-list" v-if="cartList && cartList.length">
        <!-- 优惠提示 -->
        <view class="tips">
        ...
        <uni-swipe-action>
          ...
          <uni-swipe-action-item v-for="item in cartList" :key="item.skuId" class="cart-swipe">
            ...
            <!-- 右侧删除按钮 -->
            <template #right>
              <view class="cart-swipe-right" @click="onDeleteCartItem(item.skuId)">
      ...
      <view class="toolbar">
        ...
        <view class="button-grounp">
          <view class="button payment-button" 
          @click="gotoPaymeny" 
...
<script setup lang="ts">
  import { deleteMemberCartAPI, getMemberCartAPI, putMemberCartBySkuIdAPI, putMemberCartSelectedALLAPI } from '@/services/cart';
  ...
  const onChangeInput = (ev: InputNumberBoxEvent) => {
