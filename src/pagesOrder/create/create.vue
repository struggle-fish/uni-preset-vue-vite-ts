<template>
  ...
  <view class="toolbar" :style="{ paddingBottom: safeAreaInsets?.bottom + 'px' }">
    ...
    <view class="button" :class="{ disabled: selectedAddress?.id }" @click="onSubmit"> 提交订单 </view>
  </view>
</template>
<script setup lang="ts">
import { getMemberOrderAPI, getMemberOrderNowAPI, postMemberOrderAPI } from '@/services/oreder';
